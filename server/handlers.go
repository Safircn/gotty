...
func (server *Server) titleVariables(varsUnits map[string]map[string]interface{}) map[string]interface{} {
	titleVars := map[string]interface{}{}

	for _, vars := range varsUnits {
